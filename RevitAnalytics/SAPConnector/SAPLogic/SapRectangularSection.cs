...
namespace RevitAnalytics
{
    ...
    class SapRectangularSection
    {
        ...
        #endregion
        #region constructor
        public SapRectangularSection(cSapModel my_model,SapMaterial material,string name,double t2,double t3,string note,string guid, int color, double[] modifiers)
        {
        ...
        public SapRectangularSection(cSapModel my_model, SapMaterial material, string name, double t2, double t3, string note, string guid, int color)
        {
            this.mysapmodel = my_model;
            this.material = material;
            this.name = name;
        ...
        public SapRectangularSection(cSapModel my_model, string materialName, string name, double t2, double t3, string note, string guid, int color)
        {
            this.mysapmodel = my_model;
            this.name = name;
            ...
            this.color = color;
            this.modifiers = new double[0];
            int check = mysapmodel.PropFrame.SetRectangle(this.name, this.materialName, this.t3, this.t2, this.color, this.note, this.guid);
        }
        #endregion
        #region Methods
