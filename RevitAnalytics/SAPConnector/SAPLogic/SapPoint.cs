   ...
   public class SapPoint
    {
        ...
        public static List<SapPoint> ConvertToSapPoints(cSapModel sapModel, List<Tuple<double, double, double>> cornerPoints)
        {
            return cornerPoints
                .Select(pt => new SapPoint(sapModel, pt.Item1, pt.Item2, pt.Item3))
                .ToList();
        }
