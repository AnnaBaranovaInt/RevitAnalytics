...
namespace RevitAnalytics
{
    class SapFrameElement
    {
        ...
        SapPoint point1;
        SapPoint point2;
        SapRectangularSection rectsection;
        string label;
        string name;
        ...
        #endregion
        #region Prop
        private string existingSectionName; 
        public string SectionName
        {
            get
            {
                // Safely return rectsection.Name if rectsection is not null
                return rectsection != null ? rectsection.Name : "(No Section)";
            }
        ...
        internal SapRectangularSection Rectsection { get => rectsection; set => rectsection = value; }
        ...
        #endregion
        #region Constructors
        public SapFrameElement(cSapModel mymodel ,SapPoint point1,SapPoint point2,SapRectangularSection rectsection,string label,string framename)
        {
        ...
        public SapFrameElement(cSapModel mymodel, SapPoint point1, SapPoint point2, string sectionName, string label, string framename)
        {
            this.mymodel = mymodel;
            this.point1 = point1;
            this.point2 = point2;
            this.existingSectionName = sectionName;
            this.label = label;
            this.name = framename;
            this.distibutedLoads = new List<SapFrameDistLoad>();
            this.frameResults = new List<SapFrameResult>();
            int ret = mymodel.FrameObj.AddByPoint(this.point1.Name, this.point2.Name, ref this.label, this.existingSectionName, this.name);
        }
        ...
        public SapFrameElement(cSapModel mymodel,double x11,double y11,double z11,double x22,double y22,double z22,string framename,SapRectangularSection rectsection,string label)
        {
            this.mymodel = mymodel;
            point1.X = x11;
            point1.Y = y11;
